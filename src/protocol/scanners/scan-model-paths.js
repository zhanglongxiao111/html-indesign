...
const ITEM_TABLE_CELL_FIELD_PATHS = Object.freeze({
  ...
  appliedFont: 'items[].table.rows[].cells[].appliedFont',
  fontStyleName: 'items[].table.rows[].cells[].fontStyleName',
  tracking: 'items[].table.rows[].cells[].tracking',
  capitalization: 'items[].table.rows[].cells[].capitalization',
